...
public class Skill {
    ...
    public String toString(){
        ...
        if(this.compatibleElmts.isEmpty()){sb.append("-----");}
        else{
            for(String elmts: this.compatibleElmts){sb.append("|"); sb.append(elmts);}
            sb.append("|");
        }
        return String.format("Skill Name          : %s%nBase Power          : %d%nMastery Level       : %d%nCompatible Elements : %s%n", 
